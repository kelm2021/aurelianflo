const { NHL_SIGNAL_DEFAULTS } = require("./defaults");
...
function teamToScenario(team) {
  return {
    ...
    weights: { ...NHL_SIGNAL_DEFAULTS.weights },
    uncertainty: { ...NHL_SIGNAL_DEFAULTS.uncertainty },
    outcome_noise: NHL_SIGNAL_DEFAULTS.outcome_noise,
    threshold: NHL_SIGNAL_DEFAULTS.threshold,
  };
}
